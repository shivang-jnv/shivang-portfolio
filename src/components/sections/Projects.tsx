...
const projects = [
  ...
  },
  {
    ...
    tech: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'MongoDB', 'JWT' ],
    liveUrl: "https://github.com/shivang-jnv/complaint-management-system",
    repoUrl: 'https://github.com/shivang-jnv/complaint-management-system',
    year: '2025',
    featured: false,
    category: 'Full Stack',
    metrics: { null: 'null' }
  },
  {
    ...
    tech: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'Hono', 'Prisma Accelerate', 'PostgreSQL', 'JWT', 'Cloudflare Workers'],
    liveUrl: "https://github.com/shivang-jnv/medium-clone",
    repoUrl: 'https://github.com/shivang-jnv/medium-clone',
    year: '2024',
    featured: false,
    category: 'Full Stack',
    metrics: { null: 'null' }
  },
  {
    ...
    liveUrl: 'https://github.com/shivang-jnv/live-cursors-app',
    repoUrl: 'https://github.com/shivang-jnv/live-cursors-app',
    year: '2025',
    featured: false,
    category: 'Full Stack',
